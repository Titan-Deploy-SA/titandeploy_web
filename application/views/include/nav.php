                ...
                <div class="navbar-nav mx-0 mx-lg-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="<?php echo site_url('services/software') ?>" class="dropdown-item">Custom Software Development</a>
                            <a href="<?php echo site_url('services/web') ?>" class="dropdown-item">Web Development</a>
                            <a href="<?php echo site_url('services/mobileapp') ?>" class="dropdown-item">Mobile App Development</a>
                            <a href="<?php echo site_url('services/fintech') ?>" class="dropdown-item">FinTech Solutions</a>
                            ...
                            <a href="<?php echo site_url('services/hiring') ?>" class="dropdown-item">Hire an experts</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-btn px-3">
                        <a href="<?php echo site_url("contact/") ?>" class="btn btn-primary rounded-pill py-2 px-4 ms-3 flex-shrink-0">Get Quotation</a>
                    </div>
                </div>
            </div>
